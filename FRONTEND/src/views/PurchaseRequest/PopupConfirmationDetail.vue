<template>
	<b-modal v-model="isShowPopup" dialog-class="modal-detail" @hidden="resetModal" scrollable :no-close-on-backdrop=true @ok="saveButtonAction" title="Save Confirmation - Purchase Request">
<!-- APP_DETAIL_HEADER -->
		<b-card>
			<b-col cols="12" lg="6">
...
export default {
	...
	watch : {
		...
		openPopup(newValue, oldValue) {
			if (newValue) {
				this.getPurchaseRequest(this.modelId);
